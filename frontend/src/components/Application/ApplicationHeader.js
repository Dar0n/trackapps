...
export default class ApplicationHeader extends Component {
  render() {
    const [r, g, b] = this.props.colors;
    return (
      <div className='single-application__header' style={{background: `radial-gradient(circle, rgba(${r}, ${g}, ${b}, 0.6) 0, rgba(${r}, ${g}, ${b}, 1) 70%`}}>
